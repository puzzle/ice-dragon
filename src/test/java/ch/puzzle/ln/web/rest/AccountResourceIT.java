package ch.puzzle.ln.web.rest;

import ch.puzzle.ln.IcedragonApp;
import ch.puzzle.ln.config.Constants;
import ch.puzzle.ln.domain.Authority;
import ch.puzzle.ln.domain.User;
import ch.puzzle.ln.repository.AuthorityRepository;
import ch.puzzle.ln.repository.UserRepository;
import ch.puzzle.ln.security.AuthoritiesConstants;
import ch.puzzle.ln.service.MailService;
import ch.puzzle.ln.service.UserService;
import ch.puzzle.ln.service.dto.PasswordChangeDTO;
import ch.puzzle.ln.service.dto.UserDTO;
import ch.puzzle.ln.web.rest.errors.ExceptionTranslator;
import ch.puzzle.ln.web.rest.vm.KeyAndPasswordVM;
import ch.puzzle.ln.web.rest.vm.ManagedUserVM;
 ...
 */
@SpringBootTest(classes = IcedragonApp.class)
